...
# Открытие видеофайла
video_path = "C:/Users/lolol/OneDrive/Документы/Курсовой проект/Diploma project (Дилом)/src/CNN model/bandicam 2023-06-21 03-54-13-300.mp4"
cap = cv2.VideoCapture(video_path)

# Параметры видеофайла для записи
frame_width = int(cap.get(3))
frame_height = int(cap.get(4))
output_video = cv2.VideoWriter("output_video.mp4", cv2.VideoWriter_fourcc(*"mp4v"), 25, (frame_width, frame_height))

while cap.isOpened():
    # Считывание кадра из видеофайла
    ret, frame = cap.read()
